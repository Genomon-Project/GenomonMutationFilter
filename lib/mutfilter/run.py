...
def run_realignment_filter(arg):
    ...
    realignf = realignment_filter(arg.ref_genome, arg.tumor_min_mismatch, arg.normal_max_mismatch, arg.window_size, arg.score_difference, arg.blat_path, arg.header_flag, arg.max_depth, arg.exclude_sam_flags, arg.thread_num)
    if is_anno == True:
...
def run_indel_filter(arg):
    ...
    indelf = indel_filter(arg.search_length, arg.min_depth, arg.min_mismatch, arg.af_thres, arg.neighbor, arg.header_flag, arg.samtools_path, arg.samtools_params, arg.ref_genome)
    if is_anno == True:
...
def run_breakpoint_filter(arg):
    ...
    bpf = breakpoint_filter(arg.max_depth, arg.min_clip_size, arg.junc_num_thres, arg.mapq_thres, arg.header_flag, arg.exclude_sam_flags, arg.ref_genome)
    if is_anno == True:
